...
public class ServiceUser {
    ...
    public User registerUser(RegistrationBody registrationBody) {
        ...
        user.setPassword(registrationBody.getPassword()); // Note: Passwords should be encrypted before storing.
    ...
    public User updateUser(RegistrationBody registrationBody) {
        ...
        user.setEmail(registrationBody.getEmail());
        user.setPassword(registrationBody.getPassword()); // Note: Consider encrypting the password.
        user.setRole(registrationBody.getRole());
